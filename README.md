...
- 手机终端工具栏支持横向滚动，小屏设备不会挤压核心终端区域
- 会话栏显示当前会话名称和运行状态，切换多个 Ubuntu 会话更直观
- 快捷操作增加 Home，常用终端操作更容易触达
- 保持克制的深色终端视觉，不使用渐变、卡片堆叠或 AI 风格营销元素
- 继续保持 arm64-v8a 单 ABI 和精简 rootfs 方案
